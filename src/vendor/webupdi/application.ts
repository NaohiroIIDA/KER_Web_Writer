...
import { NvmUpdiP2 } from "./nvmp2.js";
import { NvmUpdiP3 } from "./nvmp3.js";
import { NvmUpdiP4 } from "./nvmp4.js";
import { NvmUpdiP5 } from "./nvmp5.js";
...
export class UpdiApplication {
  ...
  async readDeviceInfo(): Promise<SibInfo | null> {
    ...
    } else if (sibInfo.NVM === "2") {
      this.nvm = new NvmUpdiP2(this.readwrite!, this.device);
    } else if (sibInfo.NVM === "3") {
      this.nvm = new NvmUpdiP3(this.readwrite!, this.device);
    } else if (sibInfo.NVM === "4") {
      this.nvm = new NvmUpdiP4(this.readwrite!, this.device);
    } else if (sibInfo.NVM === "5") {
      this.nvm = new NvmUpdiP5(this.readwrite!, this.device);
    } else {
